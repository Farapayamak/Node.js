...
class SoapClient {
    ...
    GetCredit = (to, from, text, isflash, scheduleStartDateTime, countrepeat, scheduleEndDateTime, periodType) =>
        this.request(ENDPOINTS.SCHEDULE, 'GetCredit', { to, from, text, isflash, scheduleStartDateTime, countrepeat, scheduleEndDateTime, periodType });
