...
class SoapClient {
    ...
    // SMART webservice
    SendSmartSMS = (to, text, from, fromSupportOne, fromSupportTwo) => this.request(ENDPOINTS.SMART, 'SendSmartSMS', {to, text, from, fromSupportOne, fromSupportTwo});
    SendMultipleSmartSMS = (to, text, from, fromSupportOne, fromSupportTwo) => this.request(ENDPOINTS.SMART, 'SendMultipleSmartSMS', {to, text, from, fromSupportOne, fromSupportTwo});
    GetSmartSMSDeliveries = (Ids) => this.request(ENDPOINTS.SMART, 'GetSmartSMSDeliveries', {Ids});
}
